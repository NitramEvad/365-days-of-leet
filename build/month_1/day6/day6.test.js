...
const day6_1 = require("./day6");
describe('Day6 tests', () => {
    test.each([
        ['abcdefg ghifjhg fsfsdsfsfsdf', true],
        ['1234567', true],
    ])('checks output is a string %s', (input, output) => {
        expect(typeof ((0, day6_1.spinWords)(input)) === 'string').toBe(output);
    });
    test.each([
        ['abcdefg', 'gfedcba'],
        ['123456', '654321'],
        ...
        expect((0, day6_1.reverseWord)(input)).toBe(output);
    });
    test.each([
        ['abcdefg', 'gfedcba'],
        ...
        expect((0, day6_1.spinWords)(input)).toBe(output);
    });
});
